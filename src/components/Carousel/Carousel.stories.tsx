...
const Template: Story<React.ComponentProps<typeof Carousel>> = () => {
  ...
  return (
    <CarouselContext.Provider value={methods}>
      <Carousel>
        <div className={clsx('bg-blue-500', itemclass)}>
          A
        </div>
        <div className={clsx('bg-red-500', itemclass)}>
          B
        </div>
        <div className={clsx('bg-green-500', itemclass)}>
          C
        </div>
        <div className={clsx('bg-orange-500', itemclass)}>
          D
        </div>
        <div className={clsx('bg-teal-500', itemclass)}>
          E
        </div>
      </Carousel>
